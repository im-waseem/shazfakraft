...
export default function HomeClient() {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', background: '#fffbf5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Poppins', sans-serif", color: '#c8860a', fontSize: 18, letterSpacing: '.04em' }}>Shazfa kraft</p>
  ...
  return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500;1,600&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;0,800;1,600;1,700&family=Inter:wght@300;400;500;600;700;800&display=swap');
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .ann-text{color:#fff;font-size:12px;font-weight:600;letter-spacing:.03em;position:relative;animation:fadeUp .4s ease}
        ...
        .logo-mark{font-family:"Poppins",sans-serif;font-size:22px;font-weight:700;color:var(--gold);letter-spacing:-.02em;line-height:1;text-decoration:none}
        .logo-sub{font-size:8px;font-weight:500;letter-spacing:.14em;text-transform:uppercase;color:var(--t3);display:block;margin-top:-1px}
        .nav-link{color:var(--t2);font-size:0.9375rem;font-weight:500;text-decoration:none;padding:5px 0;border-bottom:2px solid transparent;transition:all .18s;letter-spacing:0.005em;white-space:nowrap}
        ...
        .mob-nav-link{display:block;padding:12px 14px;border-radius:10px;color:var(--text);font-weight:500;font-size:0.9375rem;text-decoration:none;transition:background .15s}
        ...
        .guest-toast a{color:var(--gold);font-weight:700;text-decoration:none}
        ...
        .search-input{width:100%;padding:17px 24px 17px 56px;font-size:0.9375rem;font-family:inherit;background:rgba(255,255,255,.97);border:2px solid transparent;border-radius:60px;outline:none;color:var(--text);transition:all .25s;box-shadow:0 8px 32px rgba(0,0,0,.25)}
        ...
        .search-clear{position:absolute;right:8px;top:50%;transform:translateY(-50%);background:var(--t3);color:#fff;border:none;border-radius:50px;padding:9px 20px;font-family:inherit;font-size:0.8125rem;font-weight:600;cursor:pointer;transition:all .2s}
        .search-clear:hover{background:var(--t2)}
        .cat-pills{display:flex;gap:8px;flex-wrap:wrap;justify-content:center;margin-top:22px}
        .cat-pill{background:rgba(255,255,255,.1);border:1.5px solid rgba(255,255,255,.2);border-radius:50px;padding:7px 16px;font-size:0.75rem;font-weight:500;cursor:pointer;color:rgba(255,255,255,.8);transition:all .2s;font-family:inherit}
        ...
        .section-title{font-family:"Poppins",sans-serif;font-size:clamp(1.375rem,3vw,2rem);font-weight:700;color:var(--text)}
        ...
        .cat-card-name{font-size:0.75rem;font-weight:600;line-height:1.35}
        ...
        .sidebar-title{font-size:0.875rem;font-weight:700;color:var(--text);letter-spacing:.005em}
        .sidebar-label{font-size:0.6875rem;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:var(--t3);margin-bottom:12px}
        ...
        .clear-btn{background:none;border:none;color:var(--gold);font-size:0.75rem;font-weight:600;cursor:pointer;font-family:inherit;padding:0}
        .clear-btn:hover{text-decoration:underline}
        .sort-sel{background:var(--warm);border:1.5px solid var(--border2);border-radius:var(--rsm);padding:9px 32px 9px 12px;font-size:0.8125rem;font-family:inherit;color:var(--text);outline:none;cursor:pointer;appearance:none;width:100%}
        ...
        .prod-count{color:var(--t3);font-size:0.75rem;margin-top:2px}
        ...
        .add-btn{background:var(--gold);color:#fff;border:none;border-radius:50px;padding:10px;font-family:inherit;font-size:0.75rem;font-weight:600;cursor:pointer;width:100%;letter-spacing:.01em;transition:all .2s}
        ...
        .badge-featured{position:absolute;top:9px;left:9px;background:var(--gold-pale);color:var(--gold);font-size:0.5625rem;font-weight:600;padding:3px 8px;border-radius:6px;border:1px solid #e8d089;letter-spacing:.04em}
        .badge-disc{position:absolute;top:9px;left:9px;background:var(--brick);color:#fff;font-size:0.5625rem;font-weight:600;padding:3px 8px;border-radius:6px;letter-spacing:.02em}
        ...
        .p-cat{font-size:0.5625rem;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--sage)}
        .p-name{font-size:0.8125rem;font-weight:600;margin-top:3px;line-height:1.4;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;color:var(--text)}
        .p-price{font-size:1rem;font-weight:700;color:var(--gold);font-family:"Poppins",sans-serif;margin-top:7px}
        .p-compare{font-size:0.75rem;color:var(--t3);text-decoration:line-through;margin-left:7px}
        .p-low-stock{font-size:0.625rem;font-weight:600;color:#e07a40;margin-top:3px}

        /* ── MOBILE FILTER BTN ── */
        .mob-filter-btn{display:none;align-items:center;gap:8px;background:#fff;border:1.5px solid var(--border2);border-radius:50px;padding:10px 18px;font-family:inherit;font-size:0.8125rem;font-weight:500;cursor:pointer;color:var(--t2)}
        ...
        .empty-title{font-family:"Poppins",sans-serif;font-size:1.375rem;font-weight:700;margin-bottom:8px}

        /* ── LOAD MORE ── */
        .load-more-btn{background:#fff;border:2px solid var(--border2);border-radius:50px;padding:13px 36px;font-family:inherit;font-size:0.875rem;font-weight:600;cursor:pointer;color:var(--t2);transition:all .2s;display:block;margin:32px auto 0}
        ...
        .footer-logo{font-family:"Poppins",sans-serif;font-size:24px;font-weight:700;color:#d4a843;margin-bottom:10px}
        .footer-desc{color:#8a6a4a;font-size:0.8125rem;line-height:1.75}
        .footer-head{font-weight:600;font-size:0.6875rem;text-transform:uppercase;letter-spacing:.08em;color:#d4a843;margin-bottom:14px}
        .footer-link{color:#7a6050;font-size:0.8125rem;text-decoration:none;display:block;margin-bottom:8px;transition:color .18s}
        ...
        .footer-copy{color:#4a3a2a;font-size:0.75rem}
        ...
        .guest-banner{
          ...
          font-size:0.8125rem;color:var(--t2);font-weight:500;
          width:100%;
        }
        .guest-banner a{color:var(--gold);font-weight:700;text-decoration:none;border-bottom:1px solid var(--gold)}
        ...
        <div className="main-wrap">
          ...
          <main style={{ width: '100%' }}>
            ...
            <div className="prod-toolbar">
              <div>
                <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: 20, fontWeight: 700 }}>
                  {searchQuery
                        ...
                        <div className="p-img-wrap">
                          <Link href={`/products/${product.slug}`} style={{ display: 'block', height: '100%' }}>
                            {product.main_image_url || product.image_url
                              ? <img src={product.main_image_url || product.image_url} alt={product.name} className="p-img" loading="lazy" decoding="async" />
